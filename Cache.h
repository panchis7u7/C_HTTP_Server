...
extern struct entrada_cache* asignar_entrada(char* ruta, char* tipo_contenido, void* contenido, int tamano_contenido);
...
extern void put_cache(struct cache* cache, char* ruta, char* tipo_contenido, void* contenido, int tamano_contenido);
